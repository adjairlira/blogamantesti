...
<div class="ekit-onboard-tut-term">
    <input checked="checked" type="checkbox" value="user_agreed" style="display:none" name="settings[tut_term]" >
    <label class="ekit-onboard-tut-term--label">
        <?php $term = \ElementsKit_Lite\Libs\Framework\Attr::instance()->utils->get_option('settings', []);
        ?>
        <input <?php if(empty($term['tut_term']) || $term['tut_term'] !== 'user_agreed') : ?>checked="checked"<?php endif; ?> class="ekit-onboard-tut-term--input" name="settings[tut_term]" type="checkbox" value="term">
