...
class Enqueue_Scripts{
    ...
    public function elementor_js() {
        ...
        // Enqueue Scripts
        wp_enqueue_script( 'elementskit-elementor', \ElementsKit_Lite::widget_url() . 'init/assets/js/elementor.js', ['jquery', 'elementor-frontend', 'ekit-slick', 'animate-circle'], \ElementsKit_Lite::version(), true );
